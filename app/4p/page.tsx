...
export default function FourPPage() {
  return (
    <PageFrame>
      <section className="mx-auto max-w-4xl px-4 pb-16 pt-32 sm:px-6">
        <PaperCard>
          ...
          <p className="mt-4 text-sm font-light leading-7 text-[#684d40]">
            Cette rubrique présente l'analyse marketing du Kitty Café autour du
          ...
          <iframe
            title="Analyse 4P Kitty Café"
            src="/kitty-cafe-4p.pdf"
